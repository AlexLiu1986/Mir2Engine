...
namespace M2Server
{
    public partial class TfrmGeneralConfig : Form
    {
        ...
        public void Open()
        {
            ...
            EditDBName.Text = M2Share.sDBName;
        ...
        public void ButtonServerInfoSaveClick(object sender, EventArgs e)
        {
            ...
            if (DBName == "")
            {
                System.Windows.Forms.MessageBox.Show("数据库名称设置错误！！！", "错误信息", System.Windows.Forms.MessageBoxButtons.OK);
                EditDBName.Focus();
                return;
            }
            ...
            M2Share.Config.WriteString("Server", "DBName", M2Share.sDBName);

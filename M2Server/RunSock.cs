...
namespace M2Server
{
    ...
    public class TRunSocket : GameBase
    {
        ...
        private unsafe void ExecGateBuffers(int nGateIndex, TGateInfo Gate, byte[] Buffer, int nMsgLen)
        {
            ...
            IntPtr TempBuff;
            IntPtr ip;
            const string sExceptionMsg1 = "{异常} TRunSocket::ExecGateBuffers -> pBuffer";
            const string sExceptionMsg2 = "{异常} TRunSocket::ExecGateBuffers -> @pwork,ExecGateMsg ";
            const string sExceptionMsg3 = "{异常} TRunSocket::ExecGateBuffers -> FreeMem";
            nLen = 0;
            Buff = null;
            try
            {

...
namespace M2Server
{
    public class TMerchant : TNormNpc
    {
                    ...
                    *UpgradeInfo->UserItem = *User.m_UseItems[TPosition.U_WEAPON];
                    ...
                    if (StdItem->NeedIdentify == 1)
                    {
                        M2Share.AddGameDataLog("25" + "\09" + User.m_sMapName + "\09" + (User.m_nCurrX).ToString() + "\09" + (User.m_nCurrY).ToString()
                            ...
                            + "/" + (HUtil32.HiWord(StdItem->MAC)).ToString() + ")" + (User.m_UseItems[TPosition.U_WEAPON]->btValue[0]).ToString() + "/"
        ...
        {
            User.SendMsg(this, Grobal2.RM_SENDUSERSREPAIR, 0, this.ToInt(), 0, 0, "");
        }
        ...
        public unsafe void UserSelect_BuyItem(TPlayObject User, int nInt)
        {
            ...
            if (m_GoodsList.Count > 0)
            {
                for (int I = 0; I < m_GoodsList.Count; I++)
                {
                    GoodList = HUtil32.IntToObject<List<IntPtr>>(HUtil32.ObjectToInt(m_GoodsList[I]));
                    if (GoodList == null)
                    {
                        continue;
                    }
            ...
            User.SendMsg(this, Grobal2.RM_SENDGOODSLIST, 0, HUtil32.ObjectToInt(this), n10, 0, sSENDMSG);
        }
        ...
        {
            User.SendMsg(this, Grobal2.RM_SENDUSERSELL, 0, this.ToInt(), 0, 0, "");
        }

        public void UserSelect_SellSellItem(TPlayObject User)
        {
            User.SendMsg(this, Grobal2.RM_SENDUSERSELLOFFITEM, 0, this.ToInt(), 0, 0, "");
        }

        public void UserSelect_RepairItem(TPlayObject User)
        {
            User.SendMsg(this, Grobal2.RM_SENDUSERREPAIR, 0, this.ToInt(), 0, 0, "");
        }
        ...
        public unsafe void UserSelect_MakeDurg(TPlayObject User)
        {
            ...
            if (m_GoodsList.Count > 0)
            {
                for (int I = 0; I < m_GoodsList.Count; I++)
                {
                    ...
                    if (StdItem != null)
                    {
                        sSENDMSG = sSENDMSG + HUtil32.SBytePtrToString(StdItem->Name, 0, StdItem->NameLen) + "/" + 0
            ...
            if (sSENDMSG != "")
            {
                User.SendMsg(this, Grobal2.RM_USERMAKEDRUGITEMLIST, 0, HUtil32.ObjectToInt(this), 0, 0, sSENDMSG);
            }
        }
        ...
        {
            User.SendMsg(this, Grobal2.RM_USERSTORAGEITEM, 0, this.ToInt(), 0, 0, "");
        }

        public void UserSelect_GetBack(TPlayObject User)
        {
            User.SendMsg(this, Grobal2.RM_USERGETBACKITEM, 0, this.ToInt(), 0, 0, "");
        }
        ...
        public void UserSelect_BigGetBack(TPlayObject User)
        {
            ...
            User.SendMsg(this, Grobal2.RM_USERBIGGETBACKITEM, User.m_nBigStoragePage, this.ToInt(), 0, 0, "");
        }
        ...
        {
            User.SendMsg(this, Grobal2.RM_SENDUSERPLAYDRINK, 0, this.ToInt(), 0, 0, "");
        }
        ...
        public void UserSelect_OpenDealOffForm(TPlayObject User)
        {
            if (User.bo_YBDEAL)
            {
                ...
                {
                    User.SendMsg(this, Grobal2.RM_SENDDEALOFFFORM, 0, this.ToInt(), 0, 0, "");
            ...
            try
            {
                if (!m_boCastle || !((this.m_Castle != null) && m_Castle.m_boUnderWar) && (PlayObject != null))
                {
                    ...
                    if (!PlayObject.m_boDeath && (sData != "") && (sData[0] == '@'))
                    {
                        ...
                        if (HUtil32.CompareLStr(sLabel, M2Share.sUSEITEMNAME, 13)) // 检测装备
                        {
                            nCode = 2;
                            if (sMsg != "")
                            {
                        ...
                        s18 = HUtil32.mSubString(s18, 0, M2Share.sRMST.Length);
                        if ((sLabel).ToLower().CompareTo((M2Share.sSL_SENDMSG).ToLower()) == 0)
                        {
                            nCode = 3;
                            if (m_boSendmsg)
                        ...
                        else if ((s18).ToLower().CompareTo((M2Share.sRMST).ToLower()) == 0)
                        {
                            // 接受歌曲
                            nCode = 6;
                            if (m_boofflinemsg)
                        ...
                        else if ((sLabel).ToLower().CompareTo((M2Share.sofflinemsg).ToLower()) == 0)
                        {
                            // 离线挂机
                            nCode = 7;
                            if (m_boofflinemsg)
                        ...
                        else if ((sLabel).ToLower().CompareTo((M2Share.sdealgold).ToLower()) == 0)
                        {
                            nCode = 8;
                            if (m_boDealGold)
                            {
                        ...
                        else if ((sLabel).ToLower().CompareTo((M2Share.sBIGSTORAGE).ToLower()) == 0)
                        {
                            nCode = 15;
                            if (m_boBigStorage)
                            {
                        ...
                        else if ((sLabel).ToLower().CompareTo((M2Share.sBIGGETBACK).ToLower()) == 0)
                        {
                            nCode = 16;
                            if (m_boBigGetBack)
                            {
                        ...
                        else if ((sLabel).ToLower().CompareTo((M2Share.sGETPREVIOUSPAGE).ToLower()) == 0)
                        {
                            nCode = 17;
                            if (m_boBigGetBack)
                            {
                        ...
                        else if ((sLabel).ToLower().CompareTo((M2Share.sGETNEXTPAGE).ToLower()) == 0)
                        {
                            nCode = 18;
                            if (m_boBigGetBack)
                            {
                        ...
                        else if ((sLabel).ToLower().CompareTo((M2Share.sUserLevelOrder).ToLower()) == 0)
                        {
                            nCode = 19;
                        ...
                        else if ((sLabel).ToLower().CompareTo((M2Share.sWarrorLevelOrder).ToLower()) == 0)
                        {
                            nCode = 20;
                        ...
                        else if ((sLabel).ToLower().CompareTo((M2Share.sWizardLevelOrder).ToLower()) == 0)
                        {
                            nCode = 21;
                        ...
                        else if ((sLabel).ToLower().CompareTo((M2Share.sTaoistLevelOrder).ToLower()) == 0)
                        {
                            nCode = 22;
                        ...
                        else if ((sLabel).ToLower().CompareTo((M2Share.sMasterCountOrder).ToLower()) == 0)
                        {
                            nCode = 23;
                        ...
                        else if ((sLabel).ToLower().CompareTo((M2Share.sLevelOrderHomePage).ToLower()) == 0)
                        {
                            nCode = 24;
                            UserSelect_LevelOrderHomePage(PlayObject);
                        }
                        else if ((sLabel).ToLower().CompareTo((M2Share.sLevelOrderPreviousPage).ToLower()) == 0)
                        {
                            nCode = 25;
                            UserSelect_LevelOrderPreviousPage(PlayObject);
                        }
                        else if ((sLabel).ToLower().CompareTo((M2Share.sLevelOrderNextPage).ToLower()) == 0)
                        {
                            nCode = 26;
                            UserSelect_LevelOrderNextPage(PlayObject);
                        }
                        else if ((sLabel).ToLower().CompareTo((M2Share.sLevelOrderLastPage).ToLower()) == 0)
                        {
                            nCode = 27;
                            UserSelect_LevelOrderLastPage(PlayObject);
                        }
                        else if ((sLabel).ToLower().CompareTo((M2Share.sMyLevelOrder).ToLower()) == 0)
                        {
                            nCode = 28;
                            UserSelect_MyLevelOrder(PlayObject);
                        }
                        else if ((sLabel).ToLower().CompareTo((M2Share.sDealYBme).ToLower()) == 0)
                        {
                            // 元宝寄售:出售物品 20080316
                            nCode = 29;
                            if (m_boYBDeal)
                        ...
                        else if ((sLabel).ToLower().CompareTo((M2Share.sLyCreateHero).ToLower()) == 0)
                        {
                            nCode = 30;
                            if (m_boHero)
                            {
                        ...
                        else if ((sLabel).ToLower().CompareTo((M2Share.sBuHero).ToLower()) == 0)
                        {
                            // 酒馆英雄NPC
                            nCode = 39;
                            if (m_boBuHero)
                        ...
                        else if ((sLabel).ToLower().CompareTo((M2Share.sPlayDrink).ToLower()) == 0)
                        {
                            // 玩家向NPC请酒,斗酒
                            nCode = 40;
                            if (m_boPlayDrink)
                        ...
                        else if (HUtil32.CompareLStr(sLabel, M2Share.sUSEITEMNAME, 13))
                        {
                            nCode = 35;
                            if (m_boUseItemName)
                            {
        ...
        public void LoadNPCData()
        {
            ...
            try
            {
                ...
                LocalDB.GetInstance().LoadGoodRecord(this, sFile);
                LocalDB.GetInstance().LoadGoodPriceRecord(this, sFile);
                LoadUpgradeList();
            }
            catch
            {
        ...
        new public void LoadNpcScript()
        {
            ...
            try
            {
                ...
                LocalDB.GetInstance().LoadScriptFile(this, M2Share.sMarket_Def, SC, true);
            }
            catch
            {
            ...
            try
            {
                ...
                if (m_GoodsList.Count > 0)
                {
                    for (int I = 0; I < m_GoodsList.Count; I++)
                    {
                        ...
                        m_GoogList = HUtil32.IntToObject<List<IntPtr>>(HUtil32.ObjectToInt(m_GoodsList[I]));
                        if (m_GoogList == null)
                        {
                            continue;
                        }
                                                    ...
                                                    if (PlayObject.AddItemToBag(UserItem))
                                                    {
                                                        ...
                                                        if (StdItem->NeedIdentify == 1)
                                                        {
                                                            M2Share.AddGameDataLog("9" + "\09" + PlayObject.m_sMapName + "\09" + (PlayObject.m_nCurrX).ToString() + "\09" + (PlayObject.m_nCurrY).ToString()
                                                                + "\09" + PlayObject.m_sCharName + "\09" + HUtil32.SBytePtrToString(StdItem->Name, 0, StdItem->NameLen) + "\09" + (UserItem->MakeIndex).ToString() + "\09" + "(" + (HUtil32.LoWord(StdItem->DC)).ToString()
                                                                + "/" + (HUtil32.HiWord(StdItem->DC)).ToString() + ")" + "(" + (HUtil32.LoWord(StdItem->MC)).ToString() + "/" + (HUtil32.HiWord(StdItem->MC)).ToString() + ")" + "("
                                                                + (HUtil32.LoWord(StdItem->SC)).ToString() + "/" + (HUtil32.HiWord(StdItem->SC)).ToString() + ")" + "(" + (HUtil32.LoWord(StdItem->AC)).ToString() + "/" + (HUtil32.HiWord(StdItem->AC)).ToString()
        ...
        public unsafe void ClientGetDetailGoodsList(TPlayObject PlayObject, string sItemName, int nInt)
        {
            ...
            try
            {
                ...
                if (PlayObject.m_nSoftVersionDateEx == 0)
                {
                    ...
                    nCode = 7;
                    PlayObject.SendMsg(this, Grobal2.RM_SENDDETAILGOODSLIST, 0, HUtil32.ObjectToInt(this), n18, nInt, s1C);
                }
                else
                {
                    nCode = 8;
                    ...
                    if (PlayObject.IncGold(nPrice))
                    {
                        ...
                        if (StdItem->NeedIdentify == 1)
                        {
                            M2Share.AddGameDataLog("10" + "\09" + PlayObject.m_sMapName + "\09" + PlayObject.m_nCurrX + "\09" + PlayObject.m_nCurrY
                                + "\09" + PlayObject.m_sCharName + "\09" + HUtil32.SBytePtrToString(StdItem->Name, 0, StdItem->NameLen) + "\09" + UserItem->MakeIndex
                                + "\09" + "(" + (HUtil32.LoWord(StdItem->DC)).ToString() + "/" + HUtil32.HiWord(StdItem->DC) + ")" + "(" + HUtil32.LoWord(StdItem->MC)
        ...
        public unsafe bool ClientMakeDrugItem_sub_4A28FC(TPlayObject PlayObject, string sItemName)
        {
            ...
            if (result)
            {
                ...
                if (List28 != null)
                {
                    PlayObject.SendMsg(this, Grobal2.RM_SENDDELITEMLIST, 0, List28.ToInt(), 0, 0, "");
                }
            }
            return result;
        }
            ...
            try
            {
                ...
                if (m_GoodsList.Count > 0)
                {
                    for (int I = 0; I < m_GoodsList.Count; I++)
                    {
                        ...
                        if ((StdItem != null) && (HUtil32.SBytePtrToString(StdItem->Name, 0, StdItem->NameLen) == sItemName))
                        {
                                    ...
                                    if (PlayObject.AddItemToBag(UserItem))
                                    {
                                        ...
                                        if (StdItem->NeedIdentify == 1)
                                        {
                                            M2Share.AddGameDataLog("2" + "\09" + PlayObject.m_sMapName + "\09" + (PlayObject.m_nCurrX).ToString() + "\09" + (PlayObject.m_nCurrY).ToString() + "\09"
                                                + PlayObject.m_sCharName + "\09" + HUtil32.SBytePtrToString(StdItem->Name, 0, StdItem->NameLen) + "\09" + (UserItem->MakeIndex).ToString() + "\09" + "(" + (HUtil32.LoWord(StdItem->DC)).ToString() + "/"
                                                + (HUtil32.HiWord(StdItem->DC)).ToString() + ")" + "(" + (HUtil32.LoWord(StdItem->MC)).ToString() + "/" + (HUtil32.HiWord(StdItem->MC)).ToString() + ")" + "(" + (HUtil32.LoWord(StdItem->SC)).ToString()
                                                + "/" + (HUtil32.HiWord(StdItem->SC)).ToString() + ")" + "(" + (HUtil32.LoWord(StdItem->AC)).ToString() + "/" + (HUtil32.HiWord(StdItem->AC)).ToString() + ")" + "(" + (HUtil32.LoWord(StdItem->MAC)).ToString()
                                                + "/" + (HUtil32.HiWord(StdItem->MAC)).ToString() + ")" + (UserItem->btValue[0]).ToString() + "/" + (UserItem->btValue[1]).ToString() + "/" + (UserItem->btValue[2]).ToString()
                                                + "/" + (UserItem->btValue[3]).ToString() + "/" + (UserItem->btValue[4]).ToString() + "/" + (UserItem->btValue[5]).ToString() + "/" + (UserItem->btValue[6]).ToString()
                    ...
                    if (boCanRepair && (nPrice > 0) && (UserItem->DuraMax > UserItem->Dura) && (StdItem->StdMode != 43))
                    {
                        ...
                        if (PlayObject.DecGold(nRepairPrice))
                        {
                            ...
                            if (PlayObject.m_sScriptLable == M2Share.sSUPERREPAIR)
                            {
                                ...
                                PlayObject.GoldChanged();// 更新客户端金币
                                this.GotoLable(PlayObject, M2Share.sSUPERREPAIROK, false);
                            }
                            else
                            {
                                // 30
                                ...
                                PlayObject.SendMsg(this, Grobal2.RM_USERREPAIRITEM_OK, 0, PlayObject.m_nGold, UserItem->Dura, UserItem->DuraMax, "");
                                PlayObject.GoldChanged();// 更新客户端金币
                                this.GotoLable(PlayObject, M2Share.sREPAIROK, false);
                            }
                            result = true;
                        }
                        else
            ...
            try
            {
                ...
                if (btWhere >= m_UseItems.GetLowerBound(0) && btWhere <= m_UseItems.GetUpperBound(0))
                {
                    ...
                    if (UserItem->wIndex == 0)
                    {
                        ...
                        PlayObject.SendMsg(this, Grobal2.RM_MENU_OK, 0, PlayObject.ToInt(), 0, 0, sMsg);
                        return;
                    }
                    if (UserItem->btValue[13] == 1)
                    {
                    ...
                    PlayObject.SendMsg(this, Grobal2.RM_MENU_OK, 0, PlayObject.ToInt(), 0, 0, "");
                }
            }
            catch
            {

    ...
    public partial class TFrmMain : Form, IDisposable
    {
        ...
        private void RefreshData(object obj)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    {
                        nCode = 12;
                        WriteConLog(M2Share.LogonCostLogList);// 写入日志
                        nCode = 13;
                ...
                nCode = 20;
                if (_IsRun)//By John 使用异步刷新UI修正刷新网关连接状态闪烁问题
                {
            ...
            {
                M2Share.MainOutMessage("{异常} Timer1Timer Code:" + nCode);
            }
        }
        ...
        private void InitEngine(object Sender)
        {
            ...
            try
            {
                ...
                if (M2Share.g_sADODBString != null) // 设置数据库连接属性
                {
        ...
        private void StartService()
        {
            ...
            M2Share.CommandList = new List<TGameCmd>();//游戏命令列表
        ...
        public void MENU_TOOLS_IPSEARCHClick(object sender, EventArgs e)
        {
            ...
            {
                sIPaddr = "192.168.0.1";
                InputBox.Show("IP所在地区查询", "输入IP地址:", sIPaddr);

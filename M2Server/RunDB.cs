...
namespace M2Server
{
    public class RunDB
    {
        ...
        /// <param name="HumanRcd"></param>
        /// <returns></returns>
        public  static bool SaveRcd(string sAccount, string sCharName, int nSessionID, THumDataInfo HumanRcd)
        {
            bool result = false;
            ...
            SendDBSockMsg(nQueryID, EncryptUnit.EncodeMessage(EncryptUnit.MakeDefaultMsg(Common.DB_SAVEHUMANRCD, nSessionID, 0, 0, 0, 0)) + EncryptUnit.EncodeString(sAccount) + "/"
                + EncryptUnit.EncodeString(sCharName) + "/" + EncryptUnit.EncodeBuffer<THumDataInfo>(HumanRcd));
        ...
        /// <param name="HumanRcd"></param>
        /// <returns></returns>
        public  static bool SaveHeroRcd(string sAccount, string sCharName, int nSessionID, THumDataInfo HumanRcd)
        {
            bool result = false;
            int nQueryID = 0;
            int nIdent = 0;
